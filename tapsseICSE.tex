...
\SpecuSym significantly decreases, falling to only $30.75\%$ of the \texttt{Baseline} 
...
60\% less leaks in total than the \texttt{Optimized} {\sc{SpecuSym}}, in a 12-hour time-bound. 
This result highlights the utmost importance of optimizations because it energizes 
\SpecuSym to detect as many as possible leaks within a given resource budget. 
...
that optimization reduces constraint size, especially for AES~\cite{LibTomCrypt}, glibc 
DES~\cite{glibc}, and seed~\cite{Tegra}. 
