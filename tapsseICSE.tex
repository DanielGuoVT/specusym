...
After state duplication, the new state ${s'}$ becomes a \textit{speculative state}, 
since it is about to mimic the speculative execution of the mispredicted branch 
before resuming $s$. We let \SpecuSym execute $s'$ 
(line 24) and evaluate the effects of the memory visits in $s'$ on the cache 
(line 15). Details of the evaluation presents in Section
...
we construct a speculative scenario and retain the latest cache. Our 
