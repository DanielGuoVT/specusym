...
\textsc{SpecuSym}. KLEESPECTRE~\cite{WangCBMR19} has a similar 
...
thus it has different direction of constraint semantics. Spectector 
...
a threshold, which improves the efficiency of symbolic execution 
technique.


To conclude, existing works may fail to generate inputs, ignore cache 
affects from speculative execution, or model speculation for different 
