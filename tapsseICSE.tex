...
\begin{abstract}
  ...
  timing variances. Speculative execution, a vital CPU optimization and a reason for such 
	variance, can engender severe detriment from deliberate branch mispredictions.
  %
...
\keywords{Speculative execution, cache, side-channel leak, symbolic execution} 
