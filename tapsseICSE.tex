...
\begin{abstract}
  CPU cache is a limited but crucial storage component in modern processors, 
	...
	an essential processor optimization, and a source of such variance, can cause 
  ...
  We have implemented \textsc{SpecuSym} atop KLEE and evaluated it against 15 
	...
	detected from 2 to 61 leaks in 6 programs under 4 different cache settings and 
