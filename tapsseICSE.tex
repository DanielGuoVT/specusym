...
\begin{abstract}
  CPU cache is a limited but crucial storage component in processors, whereas the 
	cache timing side-channel may inadvertently leak information through the measurable 
  ...
  This work proposes a new method, \textit{Speculative symbolic Execution} (SSE), 
	...
	based on a specified cache model and conducts a constraint-solving based cache 
	behavior analysis to generate leak witnesses.
  %
  We have realized SSE in a tool named \SpecuSym atop KLEE and evaluated it against 
