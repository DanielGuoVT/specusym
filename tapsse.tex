...
\begin{abstract}
  CPU cache is limited but crucial storage on modern processors whereas the cache 
  timing side-channel may indirectly leak data through the physically measurable 
  timing variances. Speculative execution, a reason for the variance and a vital 
